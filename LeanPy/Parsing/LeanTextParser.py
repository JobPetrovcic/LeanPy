...
from LeanPy.Structures.Environment.Declaration.Declaration import Axiom, Constructor, Declaration, DeclarationInfo, Definition, Inductive, Opaque, Quot, RecursorRule, Recursor, Theorem
...
class LeanFormatParser:
    ...
    def add_expression_proj(self, parts : List[str]):
        ...
        eid, _, hid, index, expr = LeanFormatParser.process_types(parts, [int, str, int, int, int])
