...
from LeanPy.Structures.Environment.Declaration.Declaration import Constructor, Declaration, Definition, InductiveType, Opaque, Quot, Theorem
...
class Environment:
    ...
    def create_fresh_anonymous_subname(self) -> SubName:
        ret = SubName(self.anonymous, f"anon_{self.anonymous_name_count}")
        self.anonymous_name_count += 1
        return ret
